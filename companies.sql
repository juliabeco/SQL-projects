...
#Ingresar empresas nuevas y luego eliminar alguna
INSERT INTO empresas (id, nombre, sector) VALUES
(4, 'Empresa D', 'Energía'),
(5, 'Empresa E', 'Consumo'),
...
#Seguir mostrando las tablas

SELECT * FROM precios_acciones;
SELECT * FROM ingresos;
SELECT * FROM gastos;

#ANALISIS DE TENDENCIA PRECIO DE ACCIONES
...
SELECT ingresos.empresa_id, ingresos.año, (ingresos - gastos) / ingresos AS margen_beneficio
FROM ingresos
JOIN gastos ON ingresos.empresa_id = gastos.empresa_id AND ingresos.año = gastos.año;

#COMPARAR ENTRE EMPRESAS
SELECT e.nombre, AVG((i.ingresos - g.gastos) / i.ingresos) AS promedio_margen_beneficio
FROM empresas e
...
#EXPORTAR CSV FILES PARA CREAR UN DAHSBOARD EN POWER BI (VER POWER BI PROJECTS)
